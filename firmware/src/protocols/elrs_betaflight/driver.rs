//! This module is an adaptation of ELRS, from Betaflight. It's a derivative product
//! compared to the official ELRS repo, but is designed expicitly to be used on flight
//! controllers.
//!
//! https://github.com/betaflight/betaflight/blob/master/src/main/drivers/rx/expresslrs_driver.h
//! https://github.com/betaflight/betaflight/blob/master/src/main/drivers/rx/expresslrs_driver.c
//! https://github.com/betaflight/betaflight/blob/master/src/main/drivers/rx/rx_sx1280.h
//! https://github.com/betaflight/betaflight/blob/master/src/main/drivers/rx/rx_sx1280.c
...
const TIMER_INTERVAL_US_DEFAULT: u32 = 20_000;
const TICK_TOCK_COUNT: usize = 2;  // todo: define. type?
...
fn expressLrsRecalculatePhaseShiftLimits() {
...
fn TimerResume() {
    timerState.tickTock = TickTock::TOCK;
...
fn InitialiseTimer(TIM_TypeDef *t, timerOvrHandlerRec_t *timerUpdateCb) {
    timer = t;
...
fn expressLrsTimerEnableIRQs() {
    let irq: u8 = timerInputIrq(timer);
